...
class TransactionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<TransactionListBloc>(
      create: (context) => injector.get<TransactionListBloc>()
        ..add(const TransactionListEvent.read()),
        ...
        return Scaffold(
          ...
          body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final keyGroup = state.transactions.keys.elementAt(index);
              return TransactionDaysWidget(
                transaction: state.transactions[keyGroup]!,
                date: keyGroup,
              );
            },
          ),
